    ...
    {!! CollectiveForm::open([
        ...
        <div class="form-row mt-5">
            ...
            <div class="form-group col-lg-8 row">
                {!! CollectiveForm::label('category', trans('ticketit::lang.category') . trans('ticketit::lang.colon'), ['class' => 'col-lg-2 ml-4 col-form-label']) !!}
                <div class="col-lg-8">
                    {!! CollectiveForm::select('category_id', $categories, null, ['class' => 'form-control col-md-12', 'required' => 'required']) !!}
                </div>
            </div>
